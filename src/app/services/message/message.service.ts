...
export class MessageService {
  ...
  /**
   * Called whenever the list of all songs is updated
   * 
   * @param {boolean} sendToAll If we should send the updated song list to all users 
   */
  ...
  /**
   * Called when the user votes on a song. It calls the patch method on the api
   * 
   * @param {Message} msg The message with patched values 
   */
  ...
  /**
   * CAlled when we delete a song from the list
   * 
   * @param {Message} msg The song to remove from the list 
   */
  ...
  /**
   * Called when we finish a song and need to remove it from the list.
  ...
  /**
   * Called when the users connection gets updated or set
   * 
   * @param {Connection} connection The connection to set ours to 
   */
  ...
  /**
   * Called whenever the list of songs is updated
   * 
   * @param {Message} msgs The list of songs to set 
   */
  ...
  /**
   * Called whenever a song is updated, it updates the song at its given index in the list of all songs
   * 
   * @param {Message} msg The updated song 
   */
  ...
  /**
   * Called when we disconnect from the hub, it stops the connection and clears our list of songs
   */
